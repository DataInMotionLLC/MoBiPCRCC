//var FileSaver = require('cloud/FileSaver.js');
exports.jsPDF = function (jsPDF) {
                ...
                switch (type) {
                    ...
                    case 'save':
                       ...
                       */
                        ...
                        length = data.length;
                        //array = new Buffer(new ArrayBuffer(length));
                        //
                        var array = new Array();
                        for (i = 0; i < length; i++) {
