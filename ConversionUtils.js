...
exports.setV2 = function (NEMSISElementNumber, v3Val, compValue) {
    var _retv = "";
    ...
    switch (NEMSISElementNumber) {
        ...
        case "eDevice.03":
            if (typeof eDevice03[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = eDevice03[v3Val];
            }
            break;


        case "eDevice.06":
            if (typeof eDevice06[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = eDevice06[v3Val];
            }
            break;


        case "eDevice.07":
            if (typeof eDevice07[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = eDevice07[v3Val];
            }
            break;


        case "eDevice.09":
            if (typeof eDevice09[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = eDevice09[v3Val];
            }
            break;
        ...
        case "eExam.11":
            ...
            {
                if (typeof E1612[v3Val] === 'undefined') {
                    _retv = v3Val;
                }
                else {
                    _retv = E1612[v3Val];
        ...
        case "eExam.14":
            ...
            if (compValue === null) {
                ...
                var examSet1 = ["3513001", "3513003", "3513005", "3513007"]//General/Cervical

                if (examSet1.indexOf(compValue) !== -1) {
                    if (typeof E1614[v3Val] === 'undefined') {
                        _retv = v3Val;
                    }
                    else {
                        _retv = E1614[v3Val];
                ...
                var examSet2 = ["3513009", "3513011", "3513013"]  //Lumbar
                if (examSet2.indexOf(compValue) !== -1) {
                    if (typeof E1616[v3Val] === 'undefined') {
                        _retv = v3Val;
                    }
                    else {
                        _retv = E1616[v3Val];
                ...
                var examSet2 = ["3513015", "3513017", "3513019", "3513021", "3513023", "3513025"]
                if (examSet2.indexOf(compValue) !== -1) {
                    if (typeof E1615[v3Val] === 'undefined') {
                        _retv = v3Val;
                    }
                    else {
                        _retv = E1615[v3Val];
        ...
        case "eMedications.08":
            if (typeof eMedications08[v3Val] === 'undefined') {
                _retv = v3Val;;
            }
            else {
                _retv = eMedications08[v3Val];
            };
        ...
        case "ePayment.22":
            if (typeof ePayment22[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = ePayment22[v3Val];
            }
            break;
        ...
        case "eProcedures.02":
            ...
            break;
        case "eProcedures.03":
            if (typeof eProcedures03[v3Val] === 'undefined') {

                _retv = v3Val;
            }
            else {
                _retv = eProcedures03[v3Val];
            }
            break;
        case "eProcedures.06":
        ...
        case "eProcedures.08":
            ...
            break;
        case "eProcedures.10":
            if (typeof eProcedures10[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = eProcedures10[v3Val];
            }
            break;
        case "eProcedures.11":
        ...
        case "eSituation.11":
            if (typeof eSituation11[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = eSituation11[v3Val];
            }
            break;

        case "eSituation.12":
            if (typeof eSituation12[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = eSituation12[v3Val];
            }
            break;

        case "eSituation.14":
            if (typeof eSituation14[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = eSituation14[v3Val];
            }
            break;


        case "eSituation.15":
            if (typeof eSituation15[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = eSituation15[v3Val];
            }
            break;

        case "eSituation.16":
            if (typeof eSituation16[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = eSituation16[v3Val];
            }
            break;
        ...
        case "eInjury.01":
            if (typeof eInjury01[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = eInjury01[v3Val];
            }
            break;

        case "eInjury.02":
            if (typeof eInjury02[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = eInjury02[v3Val];
            }
            break;
        case "eInjury.05":
        ...
        case "eInjury.08":
            if (typeof eInjury08[v3Val] === 'undefined') {
                _retv = v3Val;
            }
            else {
                _retv = eInjury08[v3Val];
            }
            break;
        default:
...
var E1612 =  //Right Lower Quadrant for eExam11
{
    "3511001": "3730",
    "3511003": "3725",
    "3511005": "3730",
...
var eSituation15 =
    {
        "2815001": "820",	        //Accommodation and Food Services
        "2815003": "820",        	//Administrative and Support and Waste Management and Remediation Services
        "2815005": "790",	        //Agriculture, Forestry, Fishing and Hunting
        "2815007": "820",    	    //Arts, Entertainment, and Recreation
        "2815009": "790",	        //Construction
        "2815011": "820", 	        //Educational Services
        "2815013": "795",	        //Finance and Insurance
        "2815015": "820",            //Health Care and Social Assistance
        "2815017": "820",        	//Information
        "2815019": "795", 	        //Management of Companies and Enterprises
        "2815021": "805", 	        //Manufacturing
        "2815023": "810", 	        //Mining, Quarrying, and Oil and Gas Extraction
        "2815025": "820", 	        //Other Services (except Public Administration)
        "2815027": "820", 	        //Professional, Scientific, and Technical Services
        "2815029": "800", 	        //Public Administration
        "2815031": "795", 	        //Real Estate and Rental and Leasing
        "2815033": "815", 	        //Retail Trade
        "2815035": "825", 	        //Transportation and Warehousing
        "2815037": "825",	        //Utilities
        "2815039": "830"	            //Wholesale Trade
    };
...
exports.sete10_02 = function (eInjury2Val) {
